...
public:
  thread_pool_checker(boost::asio::io_service &io_service,
      ...
      : io_service_(io_service), timer_(io_service), threads_(threads),
        max_threads_(max_threads), threshold_seconds_(threshold_seconds),
...
void thread_pool_checker::schedule_check() {
  ...
  timer_.async_wait(boost::bind(&thread_pool_checker::on_check, this,
